...
A file is selected at runtime to be protected.

The program immediately revokes access to the file (chmod 000).

A background listener subscribes to kernel device events.
...
When the USB is removed:

Permissions are revoked again

The OS enforces access naturally, without any hacks.
